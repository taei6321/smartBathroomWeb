...
<body>
	...
	<div class="container">
		<div class="row">
			<form method="post" action="contactUsWriteAction.jsp">
				...
				<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
					...
					<thead>
						<%-- 테이블의 하나의 행, 하나의 줄 --%>
						<tr>
							<th colspan="2" style="background-color: #eeeeee; text-align: center;">고객 문의글쓰기 양식</th>
						</tr>
					</thead>
					<%-- 예시 데이터 --%>
					<tbody>
						<tr>
							<td><input type="text" class="form-control" placeholder="글 제목" name="contactUsTitle" maxlength="50"></td>
						</tr>
						<tr>
							<%-- textarea : 장문의 글을 작성할 때 사용 --%>
							<td><textarea class="form-control" placeholder="글 내용" name="contactUsContent" maxlength="2048" style="height: 350px;"></textarea></td>
						</tr>
					</tbody>
