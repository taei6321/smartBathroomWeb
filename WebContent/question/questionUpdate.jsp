...
<%-- 네비게이션구현 : 하나의 웹사이트에 전반적인 구성을 보여주는 역할 --%>
	...
	<div class="container">
		<div class="row">
			<form method="post" action="questionUpdateAction.jsp?questionID=<%= questionID %>">
				...
				<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
					...
					<thead>
						<%-- 테이블의 하나의 행, 하나의 줄 --%>
						<tr>
							<th colspan="2" style="background-color: #eeeeee; text-align: center;">견적 문의글 수정 양식</th>
						</tr>
					</thead>
					<%-- 예시 데이터 --%>
					<tbody>
						<tr>
							<td><input type="text" class="form-control" placeholder="글 제목" name="questionTitle" maxlength="50" value="<%=question.getQuestionTitle()%>"></td>
						</tr>
						<tr>
							<%-- textarea : 장문의 글을 작성할 때 사용 --%>
							<td><textarea class="form-control" placeholder="글 내용" name="questionContent" maxlength="2048" style="height: 350px;"><%=question.getQuestionContent()%></textarea></td>
						</tr>
					</tbody>
