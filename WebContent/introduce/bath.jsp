...
<%-- 네비게이션구현 : 하나의 웹사이트에 전반적인 구성을 보여주는 역할 --%>
	...
	<div style="text-align: center;">
		<div class="container" style="width:100%; float:left; display:absolute;">
			<img class="mir-png" src="../images/bath.png" style="width:60%;">
		</div>
			...
			<div class="row">
				<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
					<tbody>
						<tr>
							<br>
							<td><h3><b>스마트 욕조</b></h3></td>
						</tr>
						<tr>
							<td>
								<br>
								귀가 중 휴대폰을 이용하여 물 온도 뿐만 아니라<br>
								욕조에 받고 싶은 물의 양과 수위 조절 기능<br>
								물을 받다 급한 일이 생겼을 경우 급수 중지로 물 받는 걸 중지<br>
								바쁜 시대에 클릭 하나로 따뜻한 목욕 가능
								<br><br>
							</td>
						</tr>
					</tbody>
