...
<%-- 네비게이션구현 : 하나의 웹사이트에 전반적인 구성을 보여주는 역할 --%>
	...
	<div style="text-align: center;">
		<div class="container" style="width:100%; float:left; display:absolute;">
			<img class="mir-png" src="../images/mir.png" style="width:60%;">
		</div>
			...
			<div class="row">
				<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
					<tbody>
						<tr>
							<br>
							<td><h3><b>스마트 거울</b></h3></td>
						</tr>
						<tr>
							<td>
								<br>
								음성인식을 통해 다양한 기능을 탑재한 스마트 거울<br>
								욕실에서도 음악, 뉴스, 교통상황, 유머, 통화의 기능을 사용하여<br>
								쾌적하고 스마트한 삶을 추구할 수 있습니다.
								<br><br>
							</td>
						</tr>
					</tbody>
