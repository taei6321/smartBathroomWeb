			...
			<form method="post" action="reviewWriteAction.jsp">
				...
				<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
					...
					<thead>
						<%-- 테이블의 하나의 행, 하나의 줄 --%>
						<tr>
							<th colspan="2" style="background-color: #eeeeee; text-align: center;">후기 글쓰기 양식</th>
						</tr>
					</thead>
					<%-- 예시 데이터 --%>
					<tbody>
						...
						<tr>
							...
							<td><textarea class="form-control" placeholder="글 내용" name="reviewContent" maxlength="2048" style="height: 350px;"></textarea></td>
						</tr>
					</tbody>
