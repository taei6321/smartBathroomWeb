...
<body>
	...
	<%
		...
		if(reviewID == 0){
			...
			script.println("location.href = 'review.jsp'"); // 사용자를 이전페이지로 돌려 보내는 것
			script.println("</script>");
		}
	...
	<div class="container">
		<div class="row">
			<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
				...
				<thead>
					<tr>
						<th colspan="3" style="background-color: #eeeeee; text-align: center;">후기 글 보기</th>
					</tr>
				</thead>
				...
				<tbody>
					...
					<tr style="height:200px;">
						<td colspan="2" style="min-height: 200px; text-align: left; vertical-align: middle; padding-left:20px"><%= review.getReviewContent().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;").replaceAll(">", "&gt;").replaceAll("\n", "<br>") %></td>
					</tr>
				</tbody>
			...
			%>
					<a href="reviewUpdate.jsp?reviewID=<%=reviewID %>" class="btn btn-primary">수정</a>
					<a onclick="return confirm('정말로 삭제하시겠습니까?')" href="reviewDeleteAction.jsp?reviewID=<%=reviewID %>" class="btn btn-primary">삭제</a>
			<%
				}
			%>
