...
<%-- 네비게이션구현 : 하나의 웹사이트에 전반적인 구성을 보여주는 역할 --%>
	...
	<div style="text-align: center; background-color:white-space;">
		<div class="navbar-header" style="width:100%; float:left; display:absolute; padding: 0px 0px 2px 0px;">
			...
			<button class="btn" id="btn" type="submit" onclick="location='purchasePage.jsp'" style="background-color:white"><img class="paper-png" src="../images/paper.png" style="width:40%; height:40%"><h2><b>제품 신청서 제출</b></h2></button>
		</div>
	</div>
	<%-- 애니메이션을 담당할 자바스크립트 --%>
